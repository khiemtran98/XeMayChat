...
namespace DAO
{
    public class DataProvider
    {
        ...
        private static SqlConnection conn = new SqlConnection(@"Data Source=.;Initial Catalog=dbWebBanHang;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
